...
<body>
    ...
    <table id="buttons-table" class="text-center">
        <tr>
            <td><a id="login" href="<?= site_url("ListOfReviews/login") ?>">Continue With Your Travels</a></td>
            <td><a id="back-to-home" href="<?= site_url("ListOfReviews/homepage") ?>">Back to Home</a></td>
        </tr>
        <tr>
            <td></td>
            <td><a id="register" href="<?= site_url("ListOfReviews/register") ?>">Become a Traveller</a></td>
        </tr>
    </table>
