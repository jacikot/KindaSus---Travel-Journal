...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url("assets/css/search_and_trending.css")?>">
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-5" style="margin-left: 3vw">
            <table id="trending-top" style="width: 100%">
                <caption>Trending places</caption>
            </table>
        </div>
        <div class="offset-1 col-4 my-auto">
            <div id="search" class="text-center">
                <div id="search-title">Have you got a destination in mind?</div>
                <div id="search-box">
    ...
    <div class="row">
        <div class="col-11" style="margin-left: 3vw">
            <table id="trending-bottom">
            </table>
        </div>
    </div>
</div>
