<?= $this->include('templates/header_guest'); ?>
  ...
  <figure class="trending">
    ...
    <div class="modal fade" id="badInputModal" tabindex="-1" role="dialog" style="margin-top: -100px">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content text-center">
                ...
                <div class="modal-body">
                    <span id="modal-body-message">You have entered a place that doesn't exist.. Such a dreamer!</span>
                </div>
