        ...
        function sendData(fd){
            $.ajax({
                ...
                if(array[0] === "Success!"){
                    ...
                    $('#btn11').attr('hidden',false);
                    $('#btn11').click(goToMap);
                    $('#btn11').attr('disabled',false);
                    $('#foot').addClass('modal-footer1');
                    $('#foot').removeClass('modal-footer2');

                    $('.modal-body').text('If you want to further secure your account press Next or Press Close' +
                        ' to view your Map ');
                } else{
                    $('#btn11').attr('hidden',true);
                    $('#btn11').attr('disabled',true);
                    $('#foot').removeClass('modal-footer1');
                    $('#foot').addClass('modal-footer2');
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer modal-footer1" id="foot">
                        <button type="button" id="btn11" class="btn btn-dark" data-dismiss="modal">Close</button>
