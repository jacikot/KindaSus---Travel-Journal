                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            ?>">
                                                ...
                                                <div class="col-2"><span class="place"><?= $review->place.', '.$review->country ?></span></div>
                                                <div class="col-3">
                                                    <div class="tokens-and-date">
                                                        <div class="tokens">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="user">
                                                ...
                                                <div class="col-3">
                                                    <div class="btn delete-user delete-btn"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content text-center">
            ...
            <div class="modal-footer">
                <button type="button" id="modal-close" class="btn btn-dark" data-dismiss="modal">Cancel</button>
                <button type="button" id="modal-confirm" class="btn btn-dark">Confirm</button>
            </div>
        </div>
    </div>
</div>
