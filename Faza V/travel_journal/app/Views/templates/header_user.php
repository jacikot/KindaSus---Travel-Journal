...
<head>
    ...
    <link rel="icon" href="<?= base_url("assets/images/slike/logo_icon.png") ?>">
...
<div style="display: flex; justify-content: space-between;">
    ...
    <button class="btn btn-lg btn-success" style="margin-right: 20px; margin-top: 20px;">Passport</button>
</div>
