...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 24, 2021 at 08:31 PM
...
CREATE TABLE IF NOT EXISTS `answer` (
  ...
  `category_1` tinyint(4) NOT NULL,
  `category_2` tinyint(4) NOT NULL,
  `category_3` tinyint(4) NOT NULL,
  `category_4` tinyint(4) NOT NULL,
  `category_5` tinyint(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `badge` (
  ...
  `icon_path` varchar(255) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `country` (
  `id_cnt` tinyint(4) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `place` (
  ...
  `categorized` tinyint(4) NOT NULL,
  `category_1` tinyint(4) NOT NULL,
  `category_2` tinyint(4) NOT NULL,
  `category_3` tinyint(4) NOT NULL,
  `category_4` tinyint(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `question` (
  ...
  `text` varchar(80) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `to-go` (
  `id_usr` int(11) NOT NULL,
  `id_plc` int(11) NOT NULL,
  `crossed_off` tinyint(4) NOT NULL,
